...
*/
om_tools.dom.opt_key_case = (function opt_key_case(attr){if(cljs.core.truth_((function (){var or__11126__auto__ = (cljs.core.count.call(null,attr) < 5);if(or__11126__auto__)
...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__24298 = (((opt instanceof cljs.core.Keyword))?opt.fqn:null);var caseval__24299;
switch (G__24298){
case "for":
caseval__24299=new cljs.core.Keyword(null,"htmlFor","htmlFor",2249940112)
break;
case "class":
caseval__24299=new cljs.core.Keyword(null,"className","className",1004015509)
break;
default:
caseval__24299=opt
}
return caseval__24299;
});
...
*/
om_tools.dom.format_opts = (function format_opts(opts){return cljs.core.clj__GT_js.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__24302){var vec__24303 = p__24302;var k = cljs.core.nth.call(null,vec__24303,0,null);var v = cljs.core.nth.call(null,vec__24303,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key.call(null,k),om_tools.dom.format_opt_val.call(null,v)], null);
}),opts)));
});
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__24305 = om_tools.dom.element_args.call(null,opts,children);var opts__$1 = cljs.core.nth.call(null,vec__24305,0,null);var children__$1 = cljs.core.nth.call(null,vec__24305,1,null);return cljs.core.apply.call(null,ctor,cljs.core.flatten.call(null,cljs.core.cons.call(null,opts__$1,children__$1)));
});
