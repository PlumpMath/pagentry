...
{{
var G__27331 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27331;
continue;
}
} else
...
{var pred__27335 = cljs.core._EQ_;var expr__27336 = limit;if(cljs.core.truth_(pred__27335.call(null,1,expr__27336)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27335.call(null,2,expr__27336)))
...
var G__27338 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27339 = (limit__$1 - 1);
var G__27340 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27338;
limit__$1 = G__27339;
parts = G__27340;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___27342 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___27342))
{var replacement_27343 = temp__4090__auto___27342;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27343)));
} else
{buffer.append(ch);
}
{
