...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_26994 = 0;while(true){
var m_26995 = cljs.core.async.impl.dispatch.tasks.pop();if((m_26995 == null))
{} else
{m_26995.call(null);
if((count_26994 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__26996 = (count_26994 + 1);
count_26994 = G__26996;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__11114__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__11114__auto__)
