...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__11693__auto__,writer__11694__auto__,opt__11695__auto__){return cljs.core._write.call(null,writer__11694__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_26959 = 0;while(true){
if((i_26959 < arr.length))
{(arr[i_26959] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__11693__auto__,writer__11694__auto__,opt__11695__auto__){return cljs.core._write.call(null,writer__11694__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_26966 = (self__.level + 1);while(true){
if((i_26966 <= (new_level + 1)))
{(update[i_26966] = self__.header);
{
var G__26967 = (i_26966 + 1);
i_26966 = G__26967;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26968 = 0;while(true){
if((i_26968 <= self__.level))
{var links_26969 = (update[i_26968]).forward;if(((links_26969[i_26968]) === x__$1))
{(links_26969[i_26968] = (x__$1.forward[i_26968]));
{
var G__26970 = (i_26968 + 1);
i_26968 = G__26970;
continue;
}
} else
{{
var G__26971 = (i_26968 + 1);
i_26968 = G__26971;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__11126__auto__ = (cljs.core.truth_((function (){var and__11114__auto__ = me;if(cljs.core.truth_(and__11114__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__11114__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__11126__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__11126__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__11126__auto__,timeout__$1,me))
,msecs);
